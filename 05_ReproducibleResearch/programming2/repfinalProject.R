---
title: "finalreproducibleproject"
author: "mt"
...
#Synopsis
This report estabilished for comparison between all events in USA that causes human and Economic resources damages. The simulation resaults shows high health and Econonmic damage rate in events like Tornado, Flash Floods and TSTM winds.
...
The highest impact on Economic and people health demonstrated by Events like Tornado and TSTM winds:
